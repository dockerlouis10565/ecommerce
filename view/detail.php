            ...
            <div class="headerdiv"> 
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="../.php?action=footwear">footwear</a></li>
                        <li><a class="dropdown-item" href="../controller.php?action=household">household items</a></li>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">                      
                        <li>
                            <a class="dropdown-item" href="../controller.php?act=edit_profile&callerDetail=<?php echo urlencode($_SERVER["PHP_SELF"]); ?>">
                                edit/view profile 
                            </a>
                        </li>
                        ...
                        echo "<div class='col' >
                                <div class='card'>
                                    ...
                                    <div class='card-body' style='display: flex; flex-flow: row nowrap; height:5%;width:95%; justify-content: center; object-fit:cover;'>
                                        <form method='POST' action='../controller.php?act=FavoriteAndCart&id=".urlencode(htmlspecialchars($fullPath))."'>
                    ...
                    if ($fullPath && file_exists($fullPath)) {
                        ...
                        echo "<div class='col' >
                                <div class='card'>
                                    ...
                                    <div class='card-body' style='display: flex; flex-flow: row nowrap; height:5%;width:95%; justify-content: center; object-fit:cover;'>
                                       <form method='POST' action='../controller.php?act=details&id=".urlencode(htmlspecialchars($fullPath))."'>
