        ...
        <header > 
            <div class="headerdiv"> 
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="../controller.php?act=edit_profile">profile</a></li>
                        <li><a class="dropdown-item" href="../controller.php?act=edit_profile">edit profile </a></li>
                            ...
                            if ($fullPath && file_exists($fullPath)) {
                                ...
                                echo "<div class='col'>
                                    <div class='card'>
                                        ...
                                        <div class='card-body'>
                                            <form method='POST' action='../controller.php?act=FavoriteAndCart&id=".urlencode(htmlspecialchars($fullPath))."&boolean=true' style='display: flex; flex-flow: row nowrap; height:auto;width:95%; padding: 1px; justify-content: space-evenly;  object-fit:contain;'>
